...
insert into tipoestudiocita (id,name,notes,tipocita,modality) value (1,'TAM. INVITACION ORGANIZADA','Tiene que llevar su comprobante',1,1);
insert into tipoestudiocita (id,name,notes,tipocita,modality) value (2,'TAM. DERIVADA POR PERSONAL DE SALUD','Vengase bien preparada por favor',1,1);
insert into tipoestudiocita (id,name,notes,tipocita,modality) value (3,'TAM. ESPONTANEA (DE LA MUJER)','Vengase bien preparada por favor',1,1);
insert into tipoestudiocita (id,name,notes,tipocita,modality) value (4,'DIAG. SINTOMATOLOGIA CLINICA','Tiene que llevar su comprobante',1,1);
insert into tipoestudiocita (id,name,notes,tipocita,modality) value (5,'DIAG. CONTROL PATOLOGIA BENIGNA','Vengase bien preparada por favor',1,1);
insert into tipoestudiocita (id,name,notes,tipocita,modality) value (6,'DIAG. CONTROL PATOLOGIA MALIGNA','Vengase bien preparada por favor',1,1);
insert into tipoestudiocita (id,name,notes,tipocita,modality) value (7,'oncologia tipo A','favor de tomar agua',2,1);
...
insert into resultadoImagen (id,adequate,dateNotified,dateInterpreted,daterealized,signs,gabineterealizado,gabineteinter,MotivoInadecuada,paciente,personalrealizado,personalinter,TipoEstudioCita,TipoResultado) values (1,1,'2013-03-31','2013-03-31','2013-03-29','Ninguna',1,1,1,1,1,1,1,1);
